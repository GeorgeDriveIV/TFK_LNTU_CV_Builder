  ...
  return (
    <div className="flex flex-wrap gap-4 mb-2 justify-center">
      <div className="inline-flex flex-row items-center gap-2">
        <h2 className="text-[1.2rem] text-white">Завантажити</h2>
        <label className="p-2 text-white bg-blue-900 rounded cursor-pointer">
          <FaCloudUploadAlt className="text-[1.2rem] text-white" />
          <input
            aria-label="Завантажит"
            type="file"
            className="hidden"
            onChange={handleLoad}
            accept=".json"
      ...
      <div className="inline-flex flex-row items-center gap-2">
        <h2 className="text-[1.2rem] text-white">Експорт</h2>
        <button
